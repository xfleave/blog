            ...
            <form name="myform" id="myform" method="post">
                <div class="result-title">
                    <div class="result-list">
                        <a href="/blog/index.php/Admin/About/add"><i class="icon-font"></i>新增栏目</a>
                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <?php if(is_array($cates)): $i = 0; $__LIST__ = $cates;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                ...
                                <td>
                                    <a class="link-update" href="/blog/index.php/Admin/About/edit/id/<?php echo ($vo["cate_id"]); ?>">修改</a>
                                    <a class="link-del" href="/blog/index.php/Admin/About/del/id/<?php echo ($vo["cate_id"]); ?>" onclick="return confirm('你要删除栏目 <?php echo ($vo["cate_name"]); ?> 吗?');">删除</a>
                                </td>
