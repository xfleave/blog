    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/blog/index.php/Admin/Index/index">首页</a><span
                    ...
                    class="crumb-step">&gt;</span><span>修改作品</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <form action="/blog/index.php/Admin/Cate/edit" method="post" id="myform" name="myform"
...
<!--                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <input class="common-text required" id="title" name="cate_name" size="50" value="<?php echo ($caters["cate_name"]); ?>"
                                       type="text">
                            </td>
                        </tr>
                        <!--<tr>
